...
to a particular group or a member by his user id or username.
...
= 1.3.1 =
* Testing with wordpress 4.9
= 1.3 =
* Testing with wordpress 4.4.
= 1.2.9 =
* Some corrections in the style4.
* Fixed font size in: style2,style3,style4.
= 1.2.8 =
...
* Some adjustments in reset option.
= 1.2.7 =
* Some corrections in the style2 and style3.
= 1.2.6 =
* Minor corrections.
= 1.2.5 =
* Adding the possibility to display the message in the All panel pages of Directors or in the main only.
* Changing the color of settings page .
* A slight correction in the style (text one, two and three).
...
* Some adjustments in the style.
= 1.2.2 =
* Minor corrections in font (DroidKufi_Ben) and in function (get_plugin_data).
= 1.2.1 =
* Adding Notif-Admin-Benaceur in main menu or in submenu (in admin bar).
= 1.2 =
* Important correction of an error in cookies.
= 1.1.9 =
* Slight Correction in java (Settings saved).
= 1.1.8 =
...
= 1.1.6 =
* Some modifications and additions in the style.
= 1.1.5 =
* Some midifications.
= 1.1.4 =
* Simple additions in the style.
= 1.1.3 =
* Some adjustments in the style of the options page.
= 1.1.2 =
* Minor modifications.
= 1.1.1 =
* Some necessary adjustments in the style.
= 1.1.0 =
* Significant changes.
= 1.0 =
